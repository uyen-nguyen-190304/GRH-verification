...
def main():
    ...
    parser.add_argument("-d", type=int, required=True, help="Discriminant of the Dirichlet L-function")
    ...
    parser.add_argument("--error_window", type=float, default=1e-8, help="Error window for the intervals")
